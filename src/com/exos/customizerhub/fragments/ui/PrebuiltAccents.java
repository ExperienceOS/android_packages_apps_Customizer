...
package com.exos.customizerhub.fragments.ui;
...
import com.exos.customizerhub.utils.AccentUtils;
...
public class PrebuiltAccents extends SettingsPreferenceFragment implements
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.experienceos.theme.color.cheese")) {
            previewText.setText("Cheese");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.aospa.theme.color.red")) {
            previewText.setText("Red");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.aospa.theme.color.magenta")) {
            previewText.setText("Magenta");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.aospa.theme.color.torchred")) {
            previewText.setText("Torch Red");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.aospa.theme.color.dodgerblue")) {
            previewText.setText("Dodger Blue");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.space")) {
            previewText.setText("Space");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.green")) {
            previewText.setText("Green");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.black")) {
            previewText.setText("Black");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.orchid")) {
            previewText.setText("Orchid");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.aquamarine")) {
            previewText.setText("Aquamarine");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.tangerine")) {
            previewText.setText("Tangerine");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.aospa.theme.color.pixelblue")) {
            previewText.setText("Pixel Blue");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.aospa.theme.color.supernova")) {
            previewText.setText("Super Nova");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("co.aospa.theme.color.teal")) {
            previewText.setText("Teal");
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.miui")) {
    ...
    public void onClick(View view) {
           ...
           int id = view.getId(); /*to get clicked view id**/
               if (id == R.id.colorCheese) {
                       ...
                       enableAccentColor(mOverlayManager, "co.experienceos.theme.color.cheese");
