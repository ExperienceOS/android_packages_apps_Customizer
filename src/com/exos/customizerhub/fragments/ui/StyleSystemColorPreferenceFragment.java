...
import com.exos.customizerhub.preferences.PreviewLayoutPreferenceFragment;
...
public class StyleSystemColorPreferenceFragment extends PreviewLayoutPreferenceFragment implements View.OnClickListener {
    ...
    public int getPreviewSampleResIds() {
        if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.cinnamon")) {
        ...
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.ocean")) {
        ...
        } else if (com.android.internal.util.custom.CustomUtils.isThemeEnabled("com.android.theme.color.asus")) {
